...
const VehicleList: React.FC = () => {
  ...
  const [vehicleToDelete, setVehicleToDelete] = useState<VehicleDetail | null>(
    null
  );
      ...
      {editOpen && (
        <EditVehicleForm
          vehicle={{
            ...
            numberPlate: selectedVehicle!.licensePlate,
            vehicleTypeId: 1,
            manufacturer: null,
            model: null,
          }}
          onUpdate={(updatedVehicle) => {
            const updated = {
              ...selectedVehicle!,
              licensePlate:
                updatedVehicle.numberPlate || selectedVehicle!.licensePlate,
